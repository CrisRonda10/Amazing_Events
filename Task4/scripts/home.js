...
function estaChequeado(e) {
    ...
    filtrarCategorias(nuevosEventos, catCheck)
    handleFilter()
...
function handleFilter() {
    ...
    if (categoriasFiltradas.length) {
        resulFinal = categoriasFiltradas
    } else {
        resulFinal = nuevosEventos
    }

    if (searchString.length) { buscarValor(resulFinal, searchString) }
    crearCards(resulFinal, "#cartita")
}
